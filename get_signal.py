...
import time
from get_candles import NiftyCandles
from indicators import supertrend, supertrend_signals
...
class SuperTrendSignalGenerator:
    def __init__(self, period=None, multiplier=None):
        self.nifty_candles = NiftyCandles()
    ...
    def get_5min_candles(self, period="1d"):
        """Get 5-minute Nifty candle data"""
        try:
            candles = self.nifty_candles.get_nifty_candles(period=period, interval="5m")
            if candles.empty:
